...
import in.abc.controller.EmployeeController;
...
public class BootProj11RealTimeDiAutoConfigurationProfilesApplication {
	...
	public BootProj11RealTimeDiAutoConfigurationProfilesApplication() {
		System.out.println(
				"BootProj11RealTimeDiAutoConfigurationProfilesApplication:: Zero parm constructor...");
	}
	@Autowired
	...
	public static void main(String[] args) {
		ApplicationContext context = SpringApplication.run(BootProj11RealTimeDiAutoConfigurationProfilesApplication.class, args);
